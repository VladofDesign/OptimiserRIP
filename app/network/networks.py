...
def networks():
    while boucle==0:
        ...
        print("                       [1;34m|[33m          _  _ ____ ___ _ _ _ ____ ____ _  _        [1;34m|[0m")
        print("                       [1;34m|[33m          |\ | |___  |  | | | |  | |__/ |_/         [1;34m|[0m")
        print("                       [1;34m|[33m          | \| |___  |  |_|_| |__| |  \ | \_        [1;34m|[0m")
        ...
        if choix2=="A" or choix2=="a":
            os.popen("control.exe /name Microsoft.NetworkAndSharingCenter")
            os.popen("netsh interface ipv4 set dns name=%nomCarteReseau% static 1.1.1.1")
            os.popen("netsh interface ipv4 add dns name=%nomCarteReseau% 1.0.0.1")
